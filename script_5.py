...
# Write scenario_manager.py
with open('llm_tourism_sim/scenarios/scenario_manager.py', 'w') as f:
    f.write(scenario_manager)

print("✅ Scenario Manager created!")
print("   - TourismScenario dataclass for flexible scenario definition")
print("   - ScenarioManager for loading and managing multiple scenarios")  
print("   - Template functions for creating custom scenarios")