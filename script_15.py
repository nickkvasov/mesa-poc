...
custom_analysis_example = '''#!/usr/bin/env python3
"""
...
with open('examples/custom_analysis.py', 'w') as f:
    f.write(custom_analysis_example)

print("✅ custom_analysis.py created")