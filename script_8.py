...
# Write analysis.py
with open('llm_tourism_sim/utils/analysis.py', 'w') as f:
    f.write(analysis_utils)

print("✅ Analysis utilities created!")
print("   - Comprehensive analysis functions for all aspects of simulation results")
print("   - Policy recommendation generation based on performance metrics")
print("   - Statistical analysis and trend detection capabilities")