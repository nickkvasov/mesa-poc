# Create the Tourist agent class
tourist_agent = '''"""
...
# Write tourist.py
with open('llm_tourism_sim/agents/tourist.py', 'w') as f:
    f.write(tourist_agent)

print("✅ Tourist agent classes created!")
print("   - Base Tourist class with LLM persona integration")  
print("   - ScenarioAwareTourist with dynamic behavior adaptation")
print("   - Comprehensive behavioral modeling and social interactions")